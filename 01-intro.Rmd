...
```{r, echo = F, out.width= '75%', fig.align='center', fig.cap= "Figure.caption"}
...
\begin{figure}
  \caption{US GDP Growth Rates, 1947-2021}
  \label{Figure 2:}
    \includegraphics{GDP4721pctch.png}
\end{figure}
...
\begin{center}
    \includegraphics{IndustryVA1921.png}
\end{center}
...
\begin{figure}
\begin{center}
\caption{US Manufacturing as a share of GDP, 1997 - 2021}
\label{Figure 3:}
\includegraphics{ManuPctGDP9721.png}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\caption{Spending components of US GDP, 1947 - 2021}
\label{Figure 4:}
\includegraphics{GDPshares.png}
\end{center}
\end{figure}
